/**
 * @file linear_dp.h
 * @brief 线性动态规划问题 - 题目说明与声明
 *
 * 线性 DP 是最基础的 DP 类型，状态转移是线性的。
 * 常见模式：dp[i] 表示以第 i 个元素结尾/前 i 个元���的最优解。
 */
...
void testLinearDP();          // 测试面试者实现
void testLinearDPSolution();  // 测试解答实现

// runTests 在��文件 inline 定义，调用两个测试函数
inline void runTests() {
    testLinearDP();
    testLinearDPSolution();
}
